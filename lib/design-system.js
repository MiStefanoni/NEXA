export const DESIGN_TOKENS = {
  colors: [
    ...
    { name: "clay", value: "#843088", role: "Primary brand action" },
    { name: "teal", value: "#E47E4A", role: "Warm accent / highlight" },
    { name: "mist", value: "#F9E1CF", role: "Subtle accent surface" },
  ],
  semanticColors: [
...
export const DESIGN_SYSTEM_GUIDELINES = [
  "Use `clay` for primary actions and `teal` for active accents, links, and emphasis details.",
  "Prefer white cards on ivory canvas; use mist for soft-emphasis surfaces rather than large areas of accent color.",
