        ...
        parts: [
          {
            text: [
              ...
              "Ask whether the applicant wants to include real portfolio information when it is relevant and not already supplied.",
              "A useful portfolio question is: Você gostaria de destacar algum projeto, trabalho ou experiência no seu portfólio? Options: Sim, Não, Pular por enquanto.",
        ...
        parts: [
          {
            text: [
              ...
              "Generate between 1 and 3 services based only on factual services the applicant supplied. Do not invent extra services just to fill all service slots.",
              "Portfolio is optional. Return 0 to 3 portfolio items using only factual projects, work, or experiences supplied by the applicant.",
              "If the applicant says no to portfolio, skips portfolio, or provides no factual portfolio information, leave all portfolio fields empty.",
