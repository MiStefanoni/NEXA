    ...
    <main>
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-20">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-nexa_orange">{page.eyebrow}</p>
        ...
        <section className="mt-12 rounded-[2rem] bg-white p-8 shadow-soft lg:p-10">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-nexa_orange">{page.manifestoEyebrow}</p>
        ...
        <section className="mt-12 rounded-[2rem] bg-nexa_purple px-8 py-10 text-white shadow-soft lg:px-10">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <Link
              ...
              className="rounded-2xl bg-white px-6 py-4 text-center text-sm font-semibold text-nexa_purple shadow-soft"
            >
              {page.primaryCta}
            </Link>
            <Link
